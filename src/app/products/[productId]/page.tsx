...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <div className="py-8 pb-8 px-12 divide-y divide-zink-100 bg-white shadow-md rounded-b-md">
      <div>
        {/* MARK: BACK BUTTON
         */}
        <BackButton />
        ...
        <div className="aspect-square my-6 border border-border w-52 h-52">
          <div className="relative bg-zinc-100 w-full h-full owerflow-hidden rounded-xl">
            <Image
              src={`/${product.imageId}`}
              alt={product.name}
              loading="eager"
        ...
        <div className="mt-4">
          ...
          <div className="mt-4 space-y-6">
            <p className="text-basemax-w-prose text-muted-foreground">
              {product.description}
            </p>
          </div>
