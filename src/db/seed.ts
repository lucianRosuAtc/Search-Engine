...
import { productsTable } from './schema'
 ...
 async function main() {
   ...
   //MARK: @ts-expect-error neon-drizzle
  ...
  const productImageIDs = [
    {
      imageId: 'dark_down_jacket_1.webp',
      description:
    ...
    {
      imageId: 'dark_down_jacket_2.webp',
      description:
    ...
    {
      imageId: 'dark_fleece_jacket_1.webp',
      description:
    ...
    {
      imageId: 'dark_leather_jacket_1.webp',
      description:
    ...
    {
      imageId: 'dark_parka_jacket_1.webp',
      description:
    ...
    {
      imageId: 'dark_parka_jacket_2.webp',
      description:
    ...
    {
      imageId: 'dark_parka_jacket_3.webp',
      description:
    ...
    {
      imageId: 'dark_trench_coat_1.webp',
      description:
    ...
    {
      imageId: 'light_trench_coat_1.webp',
      description:
    ...
    {
      imageId: 'light_trench_coat_2.webp',
      description:
    ...
    {
      imageId: 'light_wind_jacket_1.webp',
      description:
    ...
    {
      imageId: 'light_wind_jacket_2.webp',
      description:
    ...
    {
      imageId: 'light_wind_jacket_3.webp',
      description:
    ...
    {
      imageId: 'light_wind_jacket_4.webp',
      description:
...
productImageIDs.forEach(({ description, imageId }, i) => {
    products.push({
        id: (i + 1).toString(),
        name: formatFileName(imageId), // Use the formatFileName function
        description,
...
//MARK: The function 'formatFileName' takes a filename as input, removes the file extension, 
// splits the filename into words by underscore, capitalizes the first letter of each word, 
// and then joins the words back together with spaces. 
// For example, it transforms 'dark_down_jacket_1.webp' into 'Dark Down Jacket 1'.
